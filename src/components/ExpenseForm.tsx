...
function ExpenseForm() {
  ...
  const [expense, setExpense] = useState<DraftExpense | Expense>(initialStateExpense)
  ...
  return (
    <form className="space-y-5" onSubmit={handleSubmit}>
      ...
      <div className="flex flex-col gap-2">
        <label htmlFor="expenseName" className="text-xl font-bold">Nombre del gasto: </label>
        <input
          type="text"
          id="expenseName"
          placeholder="Añade el nombre del gasto,e.j. Compra en el supermercado"
      ...
      <div className="flex flex-col gap-2">
        <label htmlFor="amount" className="text-xl font-bold">Cantidad: </label>
        <input
          type="number"
          id="amount"
      ...
      <div className="flex flex-col gap-2">
        <label htmlFor="category" className="text-xl font-bold">Categoria: </label>
        <select
          id="category"
          className="bg-slate-100 p-2 rounded-lg"
          name="category"
      ...
      <div className="flex flex-col gap-2">
        <label htmlFor="amount" className="text-xl font-bold">Fecha del gasto: </label>
        <DatePicker
